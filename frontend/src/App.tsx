...
function tierFor(spent: number, id?: string): Tier {
...
function nextTier(spent: number, id?: string): { tier: Tier; remaining: number } | null {
...
const TIER_RANK: Record<Tier, number> = { yellow: 0, purple: 1, red: 2, green: 99 };
