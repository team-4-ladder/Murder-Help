...
/* 백엔드 ReviewResponse — 주문 상품에 리뷰를 아직 안 썼으면 null 로 온다 */
...
/* orderItemId · productCode · tier · imageUrl 은 아직 백엔드 OrderResponse.Item 에 없다.
   추가되기 전에도 화면이 깨지지 않도록 없을 수 있는 값으로 둔다. */
